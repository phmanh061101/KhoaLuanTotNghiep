        ...
        <div class="container text-center wow fadeInUp">
            <nav aria-label="Breadcrumb">
                <ol class="breadcrumb breadcrumb-dark bg-transparent justify-content-center py-0 mb-2">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Tra cứu, tìm kiếm thông tin bệnh án</li>
                </ol>
            </nav>
            <h1 class="font-weight-normal">Tra cứu, tìm kiếm thông tin bệnh án</h1>
        </div> <!-- .container -->
    </div> <!-- .banner-section -->
</div> <!-- .page-banner -->
...
<form class="contact-form mt-5"  method="POST">  
    <div class="container">
        <h1 class="text-center wow fadeInUp">Nhập mã tên bệnh nhân</h1>
        <div class="row mb-3">
            <div class="col-sm-3 input-group mb-3 wow fadeInLeft">
            </div>
            <div class="col-sm-6 input-group mb-3 wow fadeInLeft">
                <input type="text" class="form-control" name="txtTimKiem" placeholder="Nhập mã tên bệnh nhân..."<?php if(isset($_POST['txtTimKiem'])) {$id=$_POST['txtTimKiem'];  echo'value='.$id.''; } ?>>
     ...
     if(isset($_POST['txtTimKiem'])){
        ...
        if(isset($_POST['search'])){
          ...
          if(isset($search) && $search !=0){
             ...
             echo "<tbody>
             <tr>
                <td scope='row'>".$search['MaBA']."</td>
                <td scope='row'>".$search['HoTen']."</td>
                <td scope='row'>".$search['TenBenh']."</td>
              
                <td scope='row'>".$search['Tinhtrang']."</td>
