    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarSupport">
        <ul class="navbar-nav ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link" href="index.php?act=tuvan">Yêu Cầu Tư Vấn </a> <!--Counseling-->
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?act=kiemtrattb">Thông Tin Bệnh Án </a> <!--Counseling-->
          </li>
          <li class="nav-item">
            <a class="nav-link" href="index.php?act=quanly">Đặt Lịch Khám
