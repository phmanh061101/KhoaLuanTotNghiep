...
if (isset($_SESSION['systemAdmin'])) {
    ...
    include "../../Screen/SystemAdmin/View.php/Header.php"; 
    ...
    if (isset($_GET['update'])) {
        ...
        include '../SystemAdmin/View.php/Grant.php';
        ...
        switch ($act) {
            case 'phanquyen':
                $sql = thongkenhanvien();
                include '../SystemAdmin/View.php/Decentralization.php';
                break;
            case 'logout':
            ...
            case 'xemthongke':
                ...
                include '../SystemAdmin/View.php/Statistical.php';
                break;          
            default:
    ...
    include "../../Screen/SystemAdmin/View.php/Footer.php";
} else {
    # code...
